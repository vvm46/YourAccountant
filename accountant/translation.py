...
from accountant.models import Title, Services, AboutUs, Specialization, Advantages, HowWeWork, ComplexServices, \
    Contacts, Activities, OrganizationalForm, TaxSystem
...
@register(OrganizationalForm)
class OrganizationalFormTranslationOptions(TranslationOptions):
    fields = ('title',)


@register(TaxSystem)
class TaxSystemTranslationOptions(TranslationOptions):
    fields = ('title',)
